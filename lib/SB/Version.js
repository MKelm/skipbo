...
SB.Version.prototype.constructor = SB.Version;

SB.Version.prototype.getCommitHash = function(callback) {
  var fs = require('fs');
...
SB.Version.prototype.getVersionHash = function(callback) {
...
SB.Version.prototype.updateHashesFile = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  var scope = this;
