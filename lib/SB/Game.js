...
SB.Game.prototype.start = function() {
  ...
  console.log(this.players[0].cardsStack);
...
SB.Game.prototype.showCards = function() {
  ...
  for (var i = 0; i < middlePositions.length; i++) {
    ...
    if (this.cardsStack["pos"+i].length > 0) {
      ...
      this.cardsVisible.all["pos"+i] = this.cardsStack["pos"+i].length-1;
    }
  }
  ...
  for (i = 0; i < cardsPositions.length; i++) {
    ...
    if (this.players[0].cardsStack["tmp"+i].length > 0) {
      ...
      this.cardsVisible.player0["tmp"+i] = this.players[0].cardsStack["tmp"+i].length-1;
    }
  }
