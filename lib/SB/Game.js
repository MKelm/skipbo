...
SB.Game.prototype.start = function() {
  ...
  this.drawCard(-70 * sb.pixi.screen.ratio, 0, this.cards[71].value, true);
  this.drawCard(-210 * sb.pixi.screen.ratio, 0, this.cards[70].value, true);
  this.drawCard(70 * sb.pixi.screen.ratio, 0, this.cards[69].value, true);
  this.drawCard(210 * sb.pixi.screen.ratio, 0, this.cards[68].value, true);
}
