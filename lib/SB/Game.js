...
SB.Game = function() {
  ...
  this.cardsPos = {
    all : { pos: "middle", cardId: { pos0: null, pos1: null, pos2: null, pos3: null } },
    player0 : { pos: "bottom", cardId: { start: null, hand: null, tmp0: null, tmp1: null, tmp2: null, tmp3: null } },
    player1 : { pos: "right", cardId: { start: null, hand: null, tmp0: null, tmp1: null, tmp2: null, tmp3: null } },
    player2 : { pos: "top", cardId: { start: null, hand: null, tmp0: null, tmp1: null, tmp2: null, tmp3: null } },
    player3 : { pos: "left", cardId: { start: null, hand: null, tmp0: null, tmp1: null, tmp2: null, tmp3: null } }
  };
...
SB.Game.prototype.showCards = function() {
  ...
  for (var i = 0; i < middlePositions.length; i++) {
    if (this.cardsPos.all.cardId["pos"+i] !== null) {
      this.hideCard(this.cardsPos.all.cardId["pos"+i]);
      this.cardsPos.all.cardId["pos"+i] = null;
    }
    if (this.cardsStack["pos"+i].length > 0) {
      this.showCard(
      ...
      this.cardsPos.all.cardId["pos"+i] = this.cardsStack["pos"+i].length-1;
    }
  }
  ...
  for (i = 0; i < cardsPositions.length; i++) {
    if (this.cardsPos.player0.cardId["tmp"+i] !== null) {
      this.hideCard(this.cardsPos.player0.cardId["tmp"+i]);
      this.cardsPos.player0.cardId["tmp"+i] = null;
    }
    if (this.players[0].cardsStack["tmp"+i].length > 0) {
      this.showCard(
      ...
      this.cardsPos.player0.cardId["tmp"+i] = this.players[0].cardsStack["tmp"+i].length-1;
    }
  }
  // reset player0 cards start
  if (this.cardsPos.player0.cardId.start !== null) {
    this.hideCard(this.cardsPos.player0.cardId.start);
    this.cardsPos.player0.cardId.start = null;
  }
  if (this.players[0].cardsStack.start.length > 0) {
    ...
    this.cardsPos.player0.cardId.start = this.players[0].cardsStack.start.length-1;
  }
}
